...
async function verifyRecordCounts(report) {
...
async function verifyDataIntegrity(report) {
...
async function verifyPartnerRelationships(report) {
...
async function verifyDateValidity(report) {
...
async function verifyQualityLinkage(report) {
