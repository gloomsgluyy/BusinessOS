...
import {
    ...
    Anchor, Briefcase, ShieldCheck, Target, Activity, PieChart, Kanban, Map, Wallet, FolderOpen
} from "lucide-react";
...
const ICON_MAP: Record<string, React.ElementType> = {
    ...
    Ship, Factory, FlaskConical, Beaker, LineChart, Truck, Calendar, DollarSign,
    Activity, Anchor, Briefcase, ShieldCheck, Target, PieChart, Kanban, Map, Wallet, FolderOpen
};
