    ...
    try {
        ...
        const record = await prisma.dailyDelivery.create({
            data: {
                ...
                analysisMethod: data.analysisMethod, surveyorPol: data.surveyorPol, surveyorPod: data.surveyorPod,
                project: data.project, flow: data.flow, terpal: data.terpal, insurance: data.insurance,
                basePrice: parseNum(data.basePrice), basePriceNotes: data.basePriceNotes,
                poMonth: data.poMonth, product: data.product,
                arriveAtPol: parseDate(data.arriveAtPol), commenceLoading: parseDate(data.commenceLoading),
                completeLoading: parseDate(data.completeLoading), startDischarging: parseDate(data.startDischarging),
                completeDischarged: parseDate(data.completeDischarged),
                podQuantity: parseNum(data.podQuantity), lossGainCargo: parseNum(data.lossGainCargo),
                ...
                paymentDueDate: parseDate(data.paymentDueDate), paymentStatus: data.paymentStatus,
    ...
    try {
        ...
        const record = await prisma.dailyDelivery.update({
            ...
            data: {
                ...
                basePriceNotes: data.basePriceNotes, poMonth: data.poMonth, product: data.product,
